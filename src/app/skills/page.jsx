    ...
    <div className="pt-16 ">
      ...
      <div className=" grid  grid-cols-1 md:grid-cols-2 py-5 w-[90%] mx-auto gap-4">
        {Skills.map((item) => (
          <div
            key={item.id}
            className="w-[95%] bg-gradient-to-t hover:bg-gradient-to-tr scale-100 duration-1000 hover:scale-110 from-[#3774d6] via-[#849253] to-[#33cb47] mx-auto p-2 flex flex-row items-center gap-5 rounded-xl"
          >
            <Image
              src={item.image}
              width={100}
